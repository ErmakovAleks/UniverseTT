...
final class SubscriptionTermsView:
    BaseView<SubscriptionTermsViewModel,
    SubscriptionTermsViewModelOutputEvents>
{
...
"""
        ...
        let title = NSAttributedString(string: "Subscription Terms\n", attributes: titleAttributes)
